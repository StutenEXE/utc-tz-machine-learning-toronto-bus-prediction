...
X_train, X_test_val, y_train, y_test_val = train_test_split(df.drop(columns=["DELAY_LOG1P"]), df["DELAY_LOG1P"], test_size=0.4, random_state=99)
...
# test_model(id, "Linear Regression (Elasticnet)", tune_params_linear_regression_elasticnet, create_linear_regression_elasicnet)
